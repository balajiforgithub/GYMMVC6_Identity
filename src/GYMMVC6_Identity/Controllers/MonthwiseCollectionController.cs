...
namespace GYMONE.Controllers
{
    ...
    public class MonthwiseCollectionController : Controller
    {
        ...
        public MonthwiseCollectionController(IConfiguration configuration,IHostingEnvironment hostingEnvironment)
        {
        ...
        public ActionResult MonthwiseReport(FormCollection FC ,MonthwiseModel objMW)
        {
            ...
            else
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    rptH.FileName = _hostingEnvironment.MapPath("~/Reports/Monthwisecollection.rpt");
                    rptH.Load();
